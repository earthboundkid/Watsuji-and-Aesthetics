...
Examined according to Watsuji’s perspective, though genius is the individual pole of critic-genius relationship, it must not be seen as the possession of an individual alone. The _Odyssey_ is clearly a work of genius whether or not it was created by a single individual named Homer. Rather, we should see genius as the ability to create a work with a context inherent within it that spills out into the world of the audience who receive it. This process is “individual” in the sense that genius enriches the private experience of a world before opening it up to public criticism. This new world of the genius will be the crystallization of the historical and climactic conditions of its context of creation but also give rise to a new space of possibilities to project. Those great works of art like the Venus de Milo or the paintings of Picasso are great because they bring their ideals with them when they travel and instantly reconfigure the cultures into which they are introduced. Kant claims that genius is the ability to bring a rule of nature to art, but it would be better to see it as the ability to bring an object out of its context by expanding its context in unexpected new directions. What makes genius so fascinating is not just the individual accomplishment of a particular work or object, but the social achievement of an ability to create or alter the existing ethos of an aesthetic community. Genius is made possible by the pre-condition of a certain historical and climactic culture which it expresses, but genius goes beyond its origin to alter the possibility of future aesthetic experiences. Genius reads into its world with empathetic, loving identification, but then causes that empathetic love to spread to others and the world to grow.

∞BEGIN UGLY WORDS:

As per the discussion of shutai, obviously, you gotta understand genius as an active process of creation rather than passive process of observing alone. The active thing that it is which geniuses do is move between worlds. You have to get back to the self of no self (muga) that underlies the ordinary self's division from the object if you want to enter into a world. To do this requires empathy and emptiness, that is a kind of love. Love breaks down walls, it opens up the kenotic possibilities of things.

Moving from one world to another is valuable because it is how you go about revealing the seams of cleavage that make that world up. Everybody wants to cut nature at the joints, but that's really something you can only do retroactively in contrasting how things have been done so far. You put things into a new place and suddenly the seams start to show up. That's why Watsuji always says find the general in the particular. Every flower is the spring x Dogen.

What makes this process possible is the universal emptiness of things. Because everything is empty, we'll never get all the joints out. There's always going to be more to reality than we can reduce down or up.†

† The computer scientist Alan Kay remarks, "All creativity is an extended form of a joke. Most creativity is a transition from one context into another where things are more surprising. There’s an element of surprise, and especially in science, there is often laughter that goes along with the ‘Aha.’ Art also has this element. Our job is to remind us that there are more contexts than the one that we’re in—the one that we think is reality." —, http://queue.acm.org/detail.cfm?id=1039523

Genius creates something great in private, then this private greatness reconfigures the public after all the people were just hanging out in the public space get their own private values rejiggered by the introduction of this stimuli. OK, next let's dig into the private values that these geniuses are exposing to the public.

- For example, in Republic, Socrates asks about justice in the context of a crazy drunk friend. Similarly, world-traveling.
- Ex. Kuhn, Heidegger on World and World rupture


###Idols and artifacts
####The public and worlds
    - Study of Ethics
      - Seken bridges time and space
      - Seken vs. The world
        - Heidegger on the world worlding. 
####Rethinking the public/private distinction
    - Rorty
    - Mill vs Confucius maybe. 
  ...
  - Whitehead
    - Re-read my paper on Whitehead. He agrees about the need for iconodules and iconoclasts.
    - Re: Religion as loneliness vs. religion as togetherness
      ...
      - Is religion what we do with aloneness or togetherness? Yes.
####Iconizing the artifact
- Defense from Hiroshi Nara
- Guzo Saiko
    - Psychology etc.
      - Close connection of Joy & Religion
      - Beauty causes veneration
      - Physical as symbol of ideal
      - Their primitive view had its advantages
      - Intoxication
      - Art and religion were one
      - Artists as priests
    - Intro
      - We need iconoclasm and idols
      - Revived idol doesn't get any goats, but it does get revered for its beauty
    ...
    - Deepen!
  - Dogen
    - > We can see one point all these forms of Buddhism hold in common: in all these periods, religious ecstasy is clearly described to be an aesthetic ecstasy. 82 of Bein
    - > Dögen clearly disdains the power of beauty. This disregard is an expression of distrust for everything sensual. This tendency appears in all countries in all eras where there is religious tension. 83
  - Koji
    - The jawsomeness of Nara reawakened Watsuji to his own country's context but not as repetition but rebirth.
