...
To conclude this dissertation, I wanna go beyond the limits of history and milieu to dig into the roots of things. How is such destruction/deconstruction possible? Surely, it is only possible to form an abstract theory on the basis of concrete experience. One particular experience will be the key for this chapter. That experience is the experience of genius, as seen by the creator and by those who encounter it. What makes genius so great that it goes out beyond its bounds? In part, the issue is that it snails its world on its back. When you enter into a work of genius you also enter into a new world it presents.

The world of an art object is the world of criticism, so we're going to have to look at critics first. Critics gotta be lovers. And lovers gotta be religious in a way.

Second, we should ask if geniuses are individuals or something else.

Third, we want to look at the historical process of boundary pushing. A big deal in liberalism is made about the public/private distinction. On the other hand, not everybody buys it, for example totalitarians and feminists. In my view, Watsuji's politics is about letting the PP distinction double negate each other. (Dewey-esque?) That's why he waxes so poetic about these things. So, I'll look at the SoE first for clues on howabouts that works, then I'll go back into Guzo to see what these private values exactly are ish.

Finally, let's look at a real work of genius and see how it relates to its critics and translators.

What is genius? Is aesthetics independent or is it subordinate to other concerns? Is there any link between beauty and (moral) goodness? How does aesthetics relate to religion?
  - How do values become universal?
