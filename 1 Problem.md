...
* (6) We might mean that the work has a form which would be identified by an ideal observer as one that is inherently beautiful (perhaps because of the balance of the elements or some other aspect of its form).

* (7) The same meaning as (5) or (6) but _without regard_ for whether anyone will or could experience these facts. 

It seems initially clear that at least some degree of subjective involvement is prerequisite for our ordinary experience of aesthetic judgments, hence interpretation (7) can be ruled out. Aesthetic judgment must be connected to at least some possibility of aesthetic experience. DEF SEVEN MORE∞
...
THESE ARE ALL ASSUMING S/O DUALITY ANYWAY!∞
