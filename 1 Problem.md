...
To speak of Plato's approach to aesthetics is peculiar in the sense that he rejects *aisthesis* <!-- [αἴσθησις][el]--> (value neutral perception) as a means of grasping Beauty itself. Plato’s aesthetics are large topic and somewhat tangential to the discussion that follows, so here I will restrict myself to a relatively brief description of his explanation of beauty in *The Republic*.

Although the phrase "beauty is in the eye of the beholder" is a mutilated paraphrase of Plato,† his actual view was nearly the opposite. For Plato, the beauty of a work is measured by how well it participates in the form of beauty (*kalon*<!-- [καλόν][el]-->, a word that means both "beautiful" and "good"), not to the subjective capacity of perceivers to recognize this beauty.

† As translated by Nehamas and Woodruff, the original quote is "when he looks at Beauty in the only way that Beauty can be seen [viz. with the intellect]---only then will it become possible for him to give birth not to images of virtue (because he's in touch with no images), but to true virtue (because he's in touch with the true Beauty)" (*Symposium*, 212a). The point of the dialogue is that only when the externally real form of beauty enters the beholder will that beholder be transformed into a truly virtuous person.

In *The Republic*, the character Socrates explains that just as the Sun is the brightest and most beautiful object in the sky, the form of the good is the most beautiful form in the intelligible realm. Socrates claims that
...
Because of this priority of the forms, the beauty of a thing is always, in a sense, predetermined. Nevertheless, there is some slight space left in Plato's thinking for a human role in the creation of beauty. The analogy being made here between the sun and the good is a little obscure from the modern perspective, so it is worth unpacking Plato’s understanding of the process of vision. In modern physics and biology, we think of a beam of light as coming from the sun, being partially reflected by an object, and finally the remaining reflection is absorbed by the eye. Plato thought that light comes from the sun and is absorbed by the object, giving it its color. Separately, the eye gives off a ray of vision which then perceives the color that now inheres in the thing. In the same way, Plato is claiming that the form of the good gives off "rays" of truth that lend to forms their essence, just as light imparts color in a thing. The beauty of a thing, therefore, is merely derivative of its relationship to the form of the good, from which all goodness, truth, and beauty originate.

Socrates stresses that the beauty of the form of the good is independent of the beauty of particular goods or beautiful things. As he says,
...
In Plato's system, the power of the form of the good overflows itself and spills out onto the intellectual realm giving the forms their beauty. The good is, we may say, the form of the forms. Being good is what all the forms have in common, hence goodness is the form above all forms.

Furthermore, all being shares at least partially in the good (to be is to be causally efficacious, and to be causally efficacious is to be able to do what it is your essential nature to do), hence goodness itself is beyond all questions of existence or non-existence. The good imparts being into things, rather than taking its being from the particulars that instantiate it as a universal:
...
Only those who know the form of the good are qualified to speak of it claims Plato. This culminates in Book X with the banishment of poets (that is, people who do *poieō* <!-- [ποιέω][el]-->, makers or imitators) from the ideal city. The problem with such creators is that they imitate things instead of imitating the forms directly. This puts them a third hand remove from the truth, since the things were made by craftspeople who only copy what they are told about the form by those who use their products.

Plato claims that really useful knowledge can only be possessed when we know the form, and this leads Socrates to ask,
...
Socrates' comment is odd, and the irony of one condemned to death by his fellow Athenians making such a remark can scarcely have escaped Plato's notice. Clearly, *The Republic* itself qualifies as a work of "poetry" given the level of craftsmanship that went into its production. Plato may have intended this riddle to have a solution, but what is clear is that this solution will not overturn the basic pattern of aesthetic established above. True beauty comes from accord with the form of the good, and human subjects must align themselves with that goodness if they are to be just and virtuous.

One final remark to be made about the aesthetics of *The Republic* is that because beauty can only be understood in terms of its source, the form of the good, there can ultimately be no separation between public good and private aesthetic bliss. The philosopher who has a private experience of leaving the cave and seeing the sun is required to return to the cave and instruct his fellow prisoners about what it is like and change their artistic practices to match the pre-existing divine pattern. In that sense, the private aesthetic feelings of the individual have no real meaning apart from their proper positioning within the public totality.
